...
namespace EeekSoft.Text
{
    ...
    public interface IStringSearchAlgorithm
    {
        ...
        List<StringSearchResult> FindAll(string text);
    ...
    public class StringSearch : IStringSearchAlgorithm
    {
        ...
        class TreeNode
        {
            ...
            public TreeNode(TreeNode parent, char c)
            {
                ...
                //_transitionsAr = new Dictionary<char,TreeNode>();
            ...
            {
                TreeNode ret;
                if (!_transHash.TryGetValue(c, out ret))ret=null;
                return ret;
            }
            ...
            //private Dictionary<char,TreeNode> _transitionsAr;
            ...
            /// </summary>
            public Dictionary<char,TreeNode> Transitions
            {
                get { return _transHash; }
            }
        ...
        void BuildTree()
        {
            ...
            foreach (var tmp in _root.Transitions)
            {
                TreeNode nd = tmp.Value;
                nd.Failure = _root;
                foreach(var trans in nd.Transitions) nodes.Add(trans.Value);
            }
